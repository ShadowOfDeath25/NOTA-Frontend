...
const MOCK_SPACES: Space[] = [
  { id: '1', name: 'Marketing Team',      description: 'Marketing campaigns and strategy',         role: 'admin',       memberCount: 12, noteCount: 45,  gradient: 'purple-pink' ,access:'private'},
  { id: '2', name: 'Product Development', description: 'Product roadmap and features',             role: 'contributor', memberCount: 8,  noteCount: 67,  gradient: 'blue-cyan' ,access:'public'  },
  { id: '3', name: 'Design Resources',    description: 'Shared design assets and guidelines',      role: 'viewer',      memberCount: 25, noteCount: 123, gradient: 'green'    ,access:'public'   },
  { id: '4', name: 'Engineering',         description: 'Technical documentation and architecture', role: 'admin',       memberCount: 15, noteCount: 89,  gradient: 'green',access:'private'  },
];

const MOCK_NOTES = [
  { id: 'n1', title: 'Q4 Marketing Strategy',    summary: 'Detailed strategy for Q4 campaigns...',        date: 'Nov 20, 02:00 AM', starred: false, tags: ['strategy', 'marketing'] },
  { id: 'n2', title: 'Campaign Ideas Brainstorm', summary: 'Collection of creative campaign concepts...', date: 'Nov 18, 02:00 AM', starred: false, tags: ['ideas', 'brainstorm']   },
  { id: 'n3', title: 'Budget Planning 2025',      summary: 'Annual budget allocations and projections...', date: 'Nov 15, 02:00 AM', starred: false, tags: ['budget', 'planning']   },
];
