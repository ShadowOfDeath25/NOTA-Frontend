        ...
        <div className="container">
            ...
            <div className={styles.section}>
                ...
                <div className={styles.row}>
                    ...
                    <Switch checked={isEmailNotificationsOn}
                            onChange={(e) => setIsEmailNotificationsOn(e.target.checked)} className={styles.switch}/>
                ...
                <div className={styles.row}>
                    ...
                    <Switch checked={isPushNotificationsOn} onChange={(e) => setIsPushNotificationsOn(e.target.checked)}
            ...
            <div className={styles.section}>
                ...
                <div className={`${styles.row} ${styles.securityRow}`}>
                    ...
                    <Switch checked={isTwoFactorAuthenticationOn}
                            onChange={(e) => setIsTwoFactorAuthenticationOn(e.target.checked)}
                            className={styles.switch}/>
